...
func displayTutorialInChatWindow(chatMessageStore: ChatMessageStore) async throws {
    let messages: [(pause: Float, image: UIImage?, text: String)] = [
        ...
        ( pause: 3, image: UIImage(named:"Tutorial_3"), text: "I can also translate whatever I hear into English.\n\nUse the gear icon at the top right to switch modes & enter your OpenAI API key." ),
